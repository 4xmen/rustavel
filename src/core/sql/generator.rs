use crate::core::table::{Column, ForeignKey, TableAction};
use std::fmt::Debug;
...
pub trait SqlGenerator: Debug + Sync + Send {
    ...
    fn disable_foreign_key_constraints(&self, db_name: &str) -> String;
    fn enable_foreign_key_constraints(&self, db_name: &str) -> String;
    fn rename(&self, old_table_name: &str, new_table_name: &str) -> String;
    fn column(&self, column: &Column,table_name: &str, action: &TableAction) -> (String, String, String);
